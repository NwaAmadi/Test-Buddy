...
import { LayoutDashboard, FileText, Users, Settings, LogOut, Menu, Bell, User } from "lucide-react"
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${
                  isActive ? "bg-gray-100 dark:bg-gray-700 text-primary" : "hover:bg-gray-100 dark:hover:bg-gray-700"
                }`}
              >
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 h-16 flex items-center px-4 justify-between">
          ...
          <div className="md:hidden font-semibold">Exam System</div>
